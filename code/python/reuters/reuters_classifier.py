...
## Classify REUTERS 21578 docs

####### Classifiy reuters 21578 docs using unigrams and bigrams features with different classifiers and report classification results
...
def test_lemmatized_unigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    ...
    # load vocabulary
    vocabulary_tbl_name = 'reuters21578_{0}{1}_lemmas{2}_unigrams{3}_df{4}_tf{5}'.format(vocabulary_src,raw_tokens_pattern,chi_features_pattern,stopwords_pattern,min_df,min_tf)
...
def test_stemmed_unigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    ...
    # load vocabulary
    vocabulary_tbl_name = 'reuters21578_{0}{1}_stems{2}_unigrams{3}_df{4}_tf{5}'.format(vocabulary_src,raw_tokens_pattern,chi_features_pattern,stopwords_pattern,min_df,min_tf)    
    vocabulary = load_vocabulary(vocabulary_tbl_name)
...
def test_stemmed_bigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    ...
    # load vocabulary
    vocabulary_tbl_name = 'reuters21578_{0}{1}_stems{2}_bigrams{3}_df{4}_tf{5}'.format(vocabulary_src,raw_tokens_pattern,chi_features_pattern,stopwords_pattern,min_df,min_tf)
    vocabulary = load_vocabulary(vocabulary_tbl_name)
...
def test_lemmatized_wiki_bigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    ...
    vocabulary_tbl_name2 = 'reuters21578_{0}{1}_lemmas{2}_bigrams{3}_df{4}_tf{5}'.format(vocabulary_src,raw_tokens_pattern,chi_features_pattern,stopwords_pattern,min_df,min_tf)
...
def test_lemmatized_wiki_bigrams_unigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    from lemmatizing_tokenizer import LemmaTokenizer
    from lemmatizing_tokenizer import RawLemmaTokenizer
    from reuters_globals import *
    from reuters_vocabulary_loader import load_common_vocabulary
...
def test_stemmed_wiki_wiktionary_bigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    from stemming_tokenizer import StemmingTokenizer
    from stemming_tokenizer import RawStemmingTokenizer
    from reuters_globals import *
    from reuters_vocabulary_loader import load_common_vocabulary
    ...
    # load vocabulary
    vocabulary_tbl_name1 = 'reuters21578_{0}{1}_stems{2}_unigrams{3}_df{4}_tf{5}'.format(vocabulary_src,raw_tokens_pattern,chi_features_pattern,stopwords_pattern,min_df,min_tf)
    vocabulary_tbl_name2 = 'reuters21578_{0}{1}_stems_bigrams{3}_df{4}_tf{5}'.format(vocabulary_src,raw_tokens_pattern,chi_features_pattern,stopwords_pattern,min_df,min_tf)
...
def test_stemmed_wiki_google_bigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    from stemming_tokenizer import StemmingTokenizer
    from stemming_tokenizer import RawStemmingTokenizer
    from reuters_globals import *
    from reuters_vocabulary_loader import load_common_vocabulary
...
def test_stemmed_wiktionary_google_bigrams(corpus_train_data,corpus_test_data,vocabulary_src,with_stopwords_removal,use_chi_features,use_raw_tokens):
    from stemming_tokenizer import StemmingTokenizer
    from stemming_tokenizer import RawStemmingTokenizer
    from reuters_globals import *
    from reuters_vocabulary_loader import load_common_vocabulary
...
def test(vocabulary_src):
    ...
    from reuters_corpus_loader import load_corpus_with_labels_mappings
    
    # load reuters docs with class lables from DB using only vocabulary_src as main field for vocabulary (e.g., abstract, description, claims...)
    ...
    chi_features_mask = 2
    raw_tokens_mask = 4
    for i in range(5,6): # test w/o stopword removal and w/o chi square features and w/o raw tokens
...
# test using reuters titles vocabulary
vocabulary_src = 'titles'
#test(vocabulary_src)

# test using reuters body vocabulary
vocabulary_src = 'body'
#test(vocabulary_src)
